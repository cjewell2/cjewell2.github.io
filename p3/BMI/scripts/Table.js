...
function listRecords() {
  ...
  if (tbRecords != null) {
    ...
    $("#tblRecords").html(
      ...
      "   <tr>" +
      "     <th>Date</th>" +
      "     <th><abbr title='Weight'>&nbsp;&nbsp;&nbsp;Wt (kg)</abbr></th>" +
      "     <th><abbr title='Height'>&nbsp;&nbsp;&nbsp;Ht (m)</abbr></th>" +
      "     <th>&nbsp;&nbsp;&nbsp;BMI (kg/m^2)</th>" +
      "     <th>Edit / Delete</th>" +
      "   </tr>" +
      "</thead>" +
    ...
    for (var i = 0; i < tbRecords.length; i++) {
      ...
      $("#tblRecords tbody").append("<tr>" +
        ...
        "  <td align='center'>" + rec.TSH + "</td>" +
        "  <td align='center'>" + rec.Tg + "</td>" +
        "  <td align='center'>" + rec.SynthroidDose +
        "</td>" +
